...
class PickupStoreController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.transaction.pickupstore.index', $this->data);
    }
    ...
    public function store(Request $request){
        ...
        try { 
            ...
            $data = array(
                ...
                'pickup_by' => GeneralFunction::myName(),
            ...
            ->update($data);
            $message = 'Successfully Complete The Order';
            DB::commit();
    ...
    public function view($id)
    {
        ...
        return view('admin.transaction.pickupstore.view', $this->data);
    }

    public function getAll(Request $request)
    {
        $data = Transaction::with('customer','statusTransaction','store')
        ->where('status','2')
        ...
        ->editColumn('store_name', function($data) {
            return ($data->store) ? $data->store->title : '-';
        })
        ...
        ->editColumn('action', function($data) {
            ...
            $url_view = route('transaction.pickupstore.view',$data->id);
            $url_edit = route('transaction.pickupstore.edit',$id_encode);
            $url_delete = route('transaction.pickupstore.destroy',$id_encode);
