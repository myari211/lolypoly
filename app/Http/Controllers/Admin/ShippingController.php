...
class ShippingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.transaction.shipping.index', $this->data);
    }
    ...
    public function view($id)
    {
        ...
        return view('admin.transaction.shipping.view', $this->data);
    }

    public function getAll(Request $request)
    {
        $data = Transaction::with('detail','statusTransaction','address')
        ->whereIn('status', array("3","9"))
        ...
        ->editColumn('action', function($data) {
            ...
            $url_view = route('transaction.shipping.view',$data->id);
            $url_edit = route('transaction.shipping.edit',$id_encode);
            $url_delete = route('transaction.shipping.destroy',$id_encode);
