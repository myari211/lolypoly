...
class ProductController extends Controller
{
    public function index($id)
    {
        ...
        $variant = DB::table('10_product_variants')->where('product_id', Crypt::decrypt($id))->get();
        ...
        return view('lolypoly-product-detail', compact('product', 'otherProducts', 'user_has_address', 'variant'));
    }
