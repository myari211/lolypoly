@extends('layouts.admin.app', ['title' => 'transaction','parent' => 'Product'])
                                        ...
                                        <table class="table cart-table table-borderless">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr class="table-order">
                                                    ...
                                                    <td>
                                                        <h4 class="theme-color fw-bold">Rp {{ $formattedPrice }}</h4>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    ...
                                    <div class="order-success">
                                        <div class="row g-4">
                                            ...
                                            <ul class="order-details list-unstyled">
                                                ...
                                                <li>Order Total: Rp {{ $formattedPrice }}</li>
                                            </ul>
