...
@section('content')
    <section class="content">
        <div id="main-content">
            <form action="{{ route('testimonial.update', ['id' => $data->id]) }}" id="submit-form">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ $data->name }}" placeholder="Enter Name" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="stars" name="stars"
                                        ...
                                        @for ($x = 5; $x >= 1; $x--)
                                            <option value="{{$x}}" {{ $data->stars == $x ? 'selected' : '' }}>{{$x}}</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea class="form-control" id="description" name="description" placeholder="Enter Description" data-validation="required">{{ $data->description }}</textarea>
								</div>
							</div>
                        </div>
                    </div>
