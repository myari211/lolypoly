...
@section('content')
    <section class="content">
        <div id="main-content">
            <form action="{{ route('promo.store') }}" id="submit-form">
                <input type="hidden" name="id" id="id" value="">
                <div class="row mb-5">
                    <div class="col-md-5">
                        <label for="title">Promo Image</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="slug" name="slug"
                                        placeholder="Enter Order" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code"
                                        placeholder="Enter Code" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="min_order">Minimal Order*</label>
                                    <input type="text" class="form-control numeric-inputmask" id="min_order"
                                        name="min_order" placeholder="Enter Minimal Order"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="start_date" name="start_date"
                                        placeholder="Enter Start Date" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="end_date" name="end_date"
                                        placeholder="Enter End Date" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control decimal-mask" id="discount_value"
                                        name="discount_value" placeholder="Enter Discount Value" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="max_discount">Max Discount*</label>
                                    <input type="text" class="form-control decimal-mask" id="max_discount"
                                        name="max_discount" placeholder="Enter Max Discount" data-validation="required">
                                </div>
                            </div>
                        </div>
                    </div>
